...
string fixedSpace = "\t\t\t";
string masterUsername = "CLMS";
string masterPassword = "CLMS";
...
string issuedStudentNames[10] = {"", "Student2", "", "Student4", ""};                           // Student who have issued the books
string students[10] = {"Student1", "Student2", "Student3", "Student4", "Student5"};             // Members of the Library
...
{
    // setcolor(8);
    cout << fixedSpace << "   ______      ____                   __    _ __                                                      " << endl;
    cout << fixedSpace << "  / ____/___  / / /__  ____ ____     / /   (_) /_  _________ ________  __                             " << endl;
    cout << fixedSpace << " / /   / __ \\/ / / _ \\/ __ `/ _ \\   / /   / / __ \\/ ___/ __ `/ ___/ / / /                             " << endl;
    cout << fixedSpace << "/ /___/ /_/ / / /  __/ /_/ /  __/  / /___/ / /_/ / /  / /_/ / /  / /_/ /                              " << endl;
    cout << fixedSpace << "\\____/\\____/_/_/\\___/\\__, /\\___/  /_____/_/_.___/_/   \\__,_/_/   \\__, /                               " << endl;
    cout << fixedSpace << "    __  ___         /____/                                   __ /____/___            __               " << endl;
    cout << fixedSpace << "   /  |/  /___ _____  ____ _____ ____  ____ ___  ___  ____  / /_   / ___/__  _______/ /____  ____ ___ " << endl;
    cout << fixedSpace << "  / /|_/ / __ `/ __ \\/ __ `/ __ `/ _ \\/ __ `__ \\/ _ \\/ __ \\/ __/   \\__ \\/ / / / ___/ __/ _ \\/ __ `__ \\" << endl;
    cout << fixedSpace << " / /  / / /_/ / / / / /_/ / /_/ /  __/ / / / / /  __/ / / / /_    ___/ / /_/ (__  ) /_/  __/ / / / / /" << endl;
    cout << fixedSpace << "/_/  /_/\\__,_/_/ /_/\\__,_/\\__, /\\___/_/ /_/ /_/\\___/_/ /_/\\__/   /____/\\__, /____/\\__/\\___/_/ /_/ /_/ " << endl;
    cout << fixedSpace << "                         /____/                                       /____/                          " << endl;
    // cout << "*****************************************************************" << endl;
...
int returnBookIndex(string name1)
{
    ...
    for (int i = 0; i < indexbook; i++)
    {
        if (name1 == books[i] || name1 == authors[i] || name1 == genres[i])
        {
            idx = i;
            break;
        }
